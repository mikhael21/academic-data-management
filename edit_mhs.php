...
<body id ="page-top">
  ...
  if(isset($_POST['Submit'])){
    ...
    $result = mysqli_query($connection, "UPDATE mahasiswa SET nrp = '$nrp', nama = '$nama', program_studi = '$program_studi', alamat = '$alamat', angkatan = '$angkatan' WHERE nrp = '$nrp'");
  ...
  $result = mysqli_query($connection, "SELECT * FROM mahasiswa WHERE nrp = '$nrp'");

  while ($data_dosen = mysqli_fetch_array($result)){
    $nip = $data_dosen['nrp'];
    $nama = $data_dosen['nama'];
    $program_studi = $data_dosen['program_studi'];
    $alamat = $data_dosen['alamat'];
    $angkatan = $data_dosen['angkatan'];
  }
  ?>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="edit_dosen.php" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" name="angkatan" type="text" value="<?php echo $angkatan; ?>" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
