...
<body id="page-top">
  ...
  $result_mhs = mysqli_query($connection, "SELECT * FROM mahasiswa, program_studi where mahasiswa.id_program_studi = program_studi.id_program_studi ORDER BY nrp ASC");
  ?>
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_mhs = mysqli_fetch_array($result_mhs)) {
                        ...
                        echo "<td>".$data_mhs['nama_program_studi']."</td>";
                        echo "<td> 
                        <a class='btn btn-success' href='edit_mhs.php?nrp=$data_mhs[nrp]'>Edit</a> 
                        <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_mhs.php?nrp=$data_mhs[nrp]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
  ...
  <!-- Sweet Alert -->
  <script src="js/sweetalert2.min"></script>
